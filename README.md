...
دنگ بان یک وب‌اپلیکیشن پیش‌رونده (PWA) مدرن، کاملاً **فارسی**، **آفلاین** و **متن‌باز** است که بدون نیاز به ثبت‌نام و اینترنت، هزینه‌ها را ثبت می‌کند و حساب همه را با کمترین تعداد کارت‌به‌کارت صاف می‌کند.
...
- ⚡ **۱۰۰٪ آفلاین و همیشه در دسترس**: در دل جنگل، کویر، جاده‌های شمال یا هواپیما که آنتن ندارید، دنگبان عین ساعت کار می‌کند.
...
- 💳 **تشخیص هوشمند شماره کارت و شبا**: شماره کارت دوستت را بزن؛ دنگ بان خودکار می‌فهمد برای کدام بانک است (بلوبانک، ملی، ملت، صادرات و...)، ۴ رقم ۴ رقم جدایش می‌کند و با لوگوی بانک تحویل می‌دهد.
...
<p align="center">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="docs/screenshots/mobile-event.png" width="300" alt="صفحه تسویه دنگ بان در موبایل" />
</p>
